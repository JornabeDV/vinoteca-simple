      ...
      <div className="bg-card border border-border/60 rounded-2xl shadow-2xl shadow-black/10 overflow-hidden">
        ...
        <div className="p-5">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-5">
            <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-2 sm:p-3">
              <PackageCheck className="w-4 h-4 text-emerald-600 mb-1.5" />
              <div className="text-sm font-bold text-emerald-700">138</div>
              <div className="text-[9px] sm:text-[10px] text-emerald-600">Productos OK</div>
            </div>
            <div className="bg-amber-50 border border-amber-100 rounded-xl p-2 sm:p-3">
              <AlertTriangle className="w-4 h-4 text-amber-600 mb-1.5" />
              <div className="text-sm font-bold text-amber-700">4</div>
              <div className="text-[9px] sm:text-[10px] text-amber-600">Stock bajo</div>
            </div>
            <div className="bg-red-50 border border-red-100 rounded-xl p-2 sm:p-3">
              ...
              <div className="text-[9px] sm:text-[10px] text-red-600">Sin stock</div>
            </div>
          </div>
          ...
          <div className="border border-border/40 rounded-xl overflow-x-auto">
            <div className="min-w-[280px]">
              ...
              {alerts.map((a, i) => (
                <div
                  key={i}
                  className="flex items-center justify-between px-4 py-3 border-t border-border/30 gap-3"
                >
                  <span className="text-xs font-medium text-foreground truncate">{a.product}</span>
