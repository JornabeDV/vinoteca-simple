...
const testimonials = [
  {
    ...
    location: "San Juan",
    text: "Antes usábamos un cuaderno y una planilla de Excel que se rompía cada dos semanas. Con VinotecaSimple todo está ordenado, sé exactamente cuánto vendo por día y qué me queda en stock. Lo mejor es que mi empleado lo usa sin que yo tenga que explicarle nada.",
    rating: 5,
    initials: "ML",
  },
  {
    ...
    shop: "Cava de Autor",
    location: "Mendoza",
    text: "Probé tres sistemas distintos antes de encontrar VinotecaSimple. Los otros eran complicados y caros. Este es justo lo que necesitaba: simple, rápido y con los números que me importan. En una semana ya sabía más de mi negocio que en los últimos dos años.",
    rating: 5,
    initials: "CM",
  },
  {
